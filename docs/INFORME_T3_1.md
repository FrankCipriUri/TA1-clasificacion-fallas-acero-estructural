...
>
> 🐍 El código fuente completo está incrustado dentro de este mismo documento (secciones II.C.1 y II.E.1), para que pueda leerse y copiarse directamente desde GitHub sin abrir archivos adicionales. También está disponible como archivos ejecutables independientes en [`src/`](../src/), junto con la guía de reproducción [`COMO_EJECUTAR.md`](../COMO_EJECUTAR.md).
